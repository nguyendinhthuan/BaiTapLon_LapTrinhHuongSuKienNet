...
namespace BaiTapLon_QuanLyLinhKien
{
    public partial class frmDanhMucHangHoa : Form
    {
        ...
        private void dgvHang_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txtMaLinhKien.Text = dgvHang.CurrentRow.Cells["MaHang"].Value.ToString();
            txtTenLinhKien.Text = dgvHang.CurrentRow.Cells["TenHang"].Value.ToString();
            ...
            sql = "SELECT Anh FROM tblHang WHERE MaHang=N'" + txtMaLinhKien.Text + "'";
            txtAnh.Text = clsConnectDB.GetFieldValues(sql);
            picAnh.Image = Image.FromFile(txtAnh.Text);
            sql = "SELECT Ghichu FROM tblHang WHERE MaHang = N'" + txtMaLinhKien.Text + "'";
